DevComPack Setup Maker
======================

A Java-based application for creating installation packages.

DevComPack Setup Maker is a compact application designed to create Java installers by  using IzPack. The application allows you to scan the directory that contains your files and to configure the installer preferences by using a wizard-like interface.
